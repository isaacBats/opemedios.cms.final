                                       ...
                                       <tbody>
                                          <tr>
                                             <td align="right" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 13px;color: #ffffff">
                                                <a href="javascript:void(0);" style="text-decoration: none; color: #ffffff"> Visita nuestra página</a> 
                                             </td>
                                          </tr>
                                       </tbody>
                                    </table>
                        ...
                        <table bgcolor="#e8eaed" width="600" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
                           <tbody>
                              <tr>
                                 <!-- start of image -->
                                 <td align="center">
                                    <a target="_blank" href="#"><img width="600" border="0" height="150" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="http://www.opemedios.com.mx/images/logo.png" class="logo"></a>
                                 </td>
                              </tr>
                           </tbody>
                        </table>
