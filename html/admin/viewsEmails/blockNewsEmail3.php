    ...
    <body>
        <table>
            <thead>
                <tr>
                    <td>
                        <a href="javascript:void(0);"><img src="http://www.suramexico.co/sura-mail/images/logo_sura.jpg"></a>                        
                    </td>
                </tr>
                <tr>
                    <td>
                        <img src="http://www.suramexico.co/sura-mail/images/tit_noticias.jpg">                        
                    </td>
                </tr>
                <tr>
                    <td>
                        <div>
                            <ul>
                                <li><a href="javascript:void(0);">PRIMERAS PLANAS</a></li>
                                <li><a href="javascript:void(0);">PORTADAS DE NEGOCIOS</a></li>
                                <li><a href="javascript:void(0);">CARTONES</a></li>
                                <li><a href="javascript:void(0);">COLUMNAS POLITICAS</a></li>
                                <li><a href="javascript:void(0);">COLUMNAS DE NEGOCIOS</a></li>
                                <li><a href="javascript:void(0);">BOLSA DE VALORES</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>                
            ...
            <tbody>
                <tr>
                    <td>
                        <img src="http://lorempixel.com/195/175">
                        ...
                        <span>( El Economista, Termometro Economico, p. 05, Salomón Rodríguez )</span>
