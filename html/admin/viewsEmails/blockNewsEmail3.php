...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body>
<!-- Start of preheader -->
<table width="100%" bgcolor="#489CDF" cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
   <tbody>
      <tr>
         <td>
                                 ...
                                 <td>
                                    ...
                                    <table width="280" align="left" border="0" cellpadding="0" cellspacing="0" class="emhide">
                                       <tbody>
                                          <tr>
                                             <td align="right">
                                                <a target="_blank" href="#"><img width="160" border="0" height="61" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="http://lorempixel.com/270/150" class="logo"></a>
                                             </td>
                                          </tr>
                                       </tbody>
                                    </table>
                        ...
                        <table bgcolor="#e8eaed" width="600" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
                           <tbody>
                              <tr>
                                 <!-- start of image -->
                                 <td align="center">
                                    <a target="_blank" href="#"><img width="600" border="0" height="150" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="http://lorempixel.com/270/150" class="logo"></a>
                                 </td>
                              </tr>
                           </tbody>
                        </table>
