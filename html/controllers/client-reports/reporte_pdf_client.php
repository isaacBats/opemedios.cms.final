...
include("../../admin/includes/phpdelegates/db_array.php");

//llamamos la clase  Data Access Object
include("../../admin/includes/phpdao/OpmDB.php");
...
require_once('../../admin/includes/tcpdf/config/lang/eng.php');
...
$pdf->SetHeaderData('opmediosLogo.png', 40, '', 'Noticias del Cliente: '.$nempresa['name'].'.');
...
<table border="1" cellspacing="2" cellpadding="2">
	<tr style="background-color:#87CEFA;">
		<th align="center" colspan="1">Monitoreo efectuado del <strong>'.strftime('%d - %m del %Y',strtotime($fecha1)).'</strong> al <strong>'.strftime('%d - %m del %Y',strtotime($fecha2)).'</strong></th>
	</tr>
	<tr>
		<td>
			<table cellspacing ="0">
