		...
		<div class="col-sm-10">
			...
			<div class="card bg-white top50">
				<div class="card-header text-right">
					...
					<a href="<?=base_url('index.php/sectores');?>"><button type="button" class="btn btn-primary"><i class="fa fa-bullhorn"></i> Sectores</button></a>
				...
				<div class="card-body">
					...
					<table class="table text-center">
						...
						<tbody>
							...
							$preview = $preview_url . "/?app=demo&id=" . $ns['id'];
							...
							echo
								...
								<tr '.$selected.'>
									...
									<td class="align-middle">'.$ns['horary'].'</td>
