    ...
    <body class="o-page">
        ...
        <div class="o-page__sidebar js-page-sidebar">
            <div class="c-sidebar">
                ...
                <ul class="c-sidebar__list">
                    <li class="c-sidebar__item">
                        <a class="c-sidebar__link is-active" href="<?=base_url('index.php/admin/categorias')?>">
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="c-table">
                            <caption class="c-table__title">
                                <a class="c-btn c-btn--blue u-ml-auto" href="#" data-toggle="modal" data-target="#modal1">Añadir Categoría</a>
                            </caption>
                            ...
                            <tbody>
                                <?php foreach ($categories as $cat) {
                                    echo 
                                    '<tr>
                                        <td class="c-table__cell">'.$cat['category_name'].'</td>
                                        <td class="c-table__cell">
                                            <a href="'.base_url('index.php/panel/edit_category/'.$cat['category_id']).'"><span class="c-badge c-badge--info c-badge--small">Editar</span></a> 
                                            <a href="'.base_url('index.php/admin/borrar_categoria/'.$cat['category_id']).'"><span class="c-badge c-badge--danger c-badge--small">Borrar</span></a> 
                                        </td>
                                    </tr>';
                                } ?>
                            </tbody>
            ...
            <div class="c-modal__dialog modal-dialog" role="document">
                <div class="c-modal__content">
                    <div class="c-modal__header">
                        <h3 class="c-modal__title">Añadir Categoría</h3>
                        <span class="c-modal__close" data-dismiss="modal" aria-label="Close">
                            <i class="fa fa-close"></i>
                        </span>
                    </div>
                    <div class="c-modal__body">
                        <form id="forma-registro-categoria">
                             <div class="c-field u-mb-small">
                                <label class="c-field__label" for="input1">Nombre de la Categoría</label> 
                                <input class="c-input" type="text" id="input1" name="category_name" maxlength="100"> 
                            </div>
                            <button class="c-btn c-btn--info c-btn--fullwidth u-mb-small" type="submit" id="btn-registro-categoria" data-action="<?=base_url('index.php/admin/registrar_categoria')?>">Registrar</button>
                            <div class="c-alert c-alert--success w-none">
                                <i class="c-alert__icon fa fa-info-circle"></i> Categoría Agregada
                            </div>
                        </form>
                    </div>
