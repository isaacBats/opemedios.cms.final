...
$route['sectores'] = 'opmedios/sectores';
...
$route['delete_sector/(:num)'] = 'opmedios/delete_sector/$1';
$route['edit_theme'] = 'opmedios/edit_theme';
$route['single_title/(:num)'] = 'opmedios/single_theme/$1';
$route['single_sector/(:num)'] = 'opmedios/single_sector/$1';
$route['preview/(:num)'] = 'opmedios/preview/$1';
$route['getmagazine/(:num)'] = 'opmedios/getMagazine/$1';
