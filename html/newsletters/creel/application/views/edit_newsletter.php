			...
			<div class="card bg-white top50">
				...
				<div class="card-body">
					...
					<form id="form_edit_newsletter">
						...
						<div class="form-group">
							<label for="candidatos_presidenciales">PORTADA ESPECTACULOS</label>
							<input type="text" class="form-control" id="candidatos_presidenciales"  name="link6" value="<?=$newsletter['link6']?>">
						</div>
					</form>
				</div>
			</div>
