...
//ENVIAR CORREO PERSONALIZADO
	...
	$(document).on('click','#add_theme',function(e){
		var $form = $('#form_add_theme'),
			$fields = $form.serialize();
 		$.ajax({
 			type : "post",
 			url  : "opmedios/add_theme",
 			data : $fields,
 		}).done(function() {
	...
	//AGREGAR SECTOR
	$(document).on('click','#add_sector',function(e){
		var $form = $('#form_add_sector'),
			$fields = $form.serialize();
 		$.ajax({
 			type : "post",
 			url  : "opmedios/add_sector",
 			data : $fields,
 		}).done(function() {
	...
	$(document).on('click','#edit_theme',function(e){
		var $form = $('#form_edit_theme'),
			$fields = $form.serialize();
 		$.ajax({
 			type : "post",
 			url  : "../opmedios/edit_theme",
 			data : $fields,
 		}).done(function() {
	 ...
	 //EDITAR SECTOR
	$(document).on('click','#edit_sector',function(e){
		var $form = $('#form_edit_sector'),
			$fields = $form.serialize();
 		$.ajax({
 			type : "post",
 			url  : "../opmedios/edit_sector",
 			data : $fields,
 		}).done(function() {
