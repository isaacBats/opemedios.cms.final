	...
	<div class="row justify-content-center">
		<div class="col-sm-10">
				...
				<div class="card-body">
					...
					<form id="form_edit_company">
						...
						<div class="form-group">
							...
							<textarea class="form-control" id="emailBcc" rows="10" name="dataMails"><?=$customer['emailBcc']?></textarea>
						</div>
					</form>
				</div>
			</div>
			...
			<div class="card bg-white top50">
				...
				<div class="card-body">
					<?php echo form_open_multipart('opmedios/imagen');?>
						<br><br>
						<img src="<?=base_url('assets/img/diamondfilms.jpg"')?>" style="max-width: 100%;display: block;">
						<br><br>
						<div class="form-group">
							<label for="file">Seleccionar Imagen (580px x 170px)</label>
							<input type="file" class="form-control" name="file" required>
						</div>
						<button href="#" class="btn btn-primary" type="submit"><i class="far fa-save"></i> Guardar Imagen</button>
					</form>
				</div>
			</div>
