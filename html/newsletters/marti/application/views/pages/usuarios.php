        ...
        <div class="o-page__sidebar js-page-sidebar">
            <div class="c-sidebar">
                ...
                <ul class="c-sidebar__list">
                    ...
                    <li class="c-sidebar__item">
                        <a class="c-sidebar__link is-active" href="<?=base_url('index.php/admin/usuarios')?>">
                    ...
                    <div class="col-md-12">
                        <table class="c-table">
                            <caption class="c-table__title">
                                Usuarios <small>Sub title</small>
                            </caption>
                            <thead class="c-table__head c-table__head--slim">
                                <tr class="c-table__row">
                                    <th class="c-table__cell c-table__cell--head">Nombre</th>
                                    <th class="c-table__cell c-table__cell--head">Apellidos</th>
                            ...
                            <tbody>
                                <?php foreach ($user as $fo) { 
                                    if ( $fo['user_status'] == 1 ) { $status = "Activo"; }       
                                    else { $status = "Inactivo"; }
                                echo 
                                    '<tr class="c-table__row">
                                        <td class="c-table__cell">'.$fo['user_name'].'</td>
                                        <td class="c-table__cell">'.$fo['user_lastName'].'</td>
                                        <td class="c-table__cell">'.$fo['user_email'].'</td>
                                        <td class="c-table__cell">'.$fo['user_phone'].'</td>
