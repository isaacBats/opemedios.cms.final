		...
		<div id="navigation" class="navigation">
			<ul class="thumbs noscript">
				<!-- <li style="float:left;">
					<a href="/assets/images/galeria/01_VILLIERS_RS1.jpg" original="/assets/images/galeria/01_VILLIERS_RS1.jpg" href="#0" rel="history"><img src="/assets/images/galeria/01_VILLIERS_RS2.jpg" alt="image01" /></a>
				</li>
				<li style="float:left;">
					<a href="/assets/images/galeria/02_ALCAZAR1.jpg" original="/assets/images/galeria/02_ALCAZAR1.jpg" href="#1" rel="history"><img src="/assets/images/galeria/02_ALCAZAR2.jpg" alt="image02" /></a>
				</li> -->
